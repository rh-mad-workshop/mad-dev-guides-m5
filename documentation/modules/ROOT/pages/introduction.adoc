...
The team decides to use the Kafka ecosystem to track the user activity since it can easily scale. Red Hat AMQ Streams (based on the upstream Strimzi) provides a Kubernetes/OpenShift-centric view of Apache kafka, provideing operator-based installation and upgrades, and cloud-native management of brokers, topics and security.
