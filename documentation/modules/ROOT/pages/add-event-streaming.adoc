...
. Go back to the Topology view, and repeat the same steps to bind the *recommendation-engine* deployment to the AMQ Streams kafka instance. Once the service binding is created, scale the deployment to 1 pod.
