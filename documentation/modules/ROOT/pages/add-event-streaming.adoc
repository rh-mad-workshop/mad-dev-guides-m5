...
. Open the URL to the *activity-tracking-simulator* application by clicking the image:console-open-url.png[] icon next to the blue circle representing the *activity-tracking-simulator* deployment.
+
